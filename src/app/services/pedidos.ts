...
export class Pedidos {
  ...
  obterPedidoPorId(id: string, email?: string): Pedido | undefined {
    const idNormalizado = this.normalizarIdPedido(id);

    return this.obterPedidos(email).find((pedido) => this.normalizarIdPedido(pedido.id) === idNormalizado);
  }
  ...
  normalizarIdPedido(id: string): string {
